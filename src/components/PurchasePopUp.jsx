          ...
          <div className="bg-white rounded-lg shadow-lg w-[600px] p-6 animate-fadeIn relative">
            {popupData.status === 'settlement' ? (
              <div className="space-y-4">
                <h2 className="text-2xl font-semibold text-green-600 mb-4">Forum Terdaftar! 🎉</h2>
                <p className="text-gray-600">Kamu sudah berhasil mendaftar pada forum:</p>
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-semibold text-[#ffa726]">Menunggu Pembayaran ⚠️</h2>
                <p className="text-gray-600">Kamu belum melakukan pembayaran, silahkan lakukan pembayaran untuk mengakses forum:</p>
                <div className="bg-gray-50 p-4 rounded-lg shadow space-y-3 border border-gray-200">
                  <p className="text-lg font-bold text-gray-800">{forum.name}</p>
                  <div className="text-gray-700">
                    <p><span className="font-medium">Order ID:</span> {popupData.order_id}</p>
                    <p><span className="font-medium">Bank:</span> {popupData.bank}</p>
                    <p>
              ...
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold text-blue-600 mb-4">Buy this Forum 💡</h2>
                <div className="bg-gray-50 p-4 rounded-lg shadow space-y-2">
                  <p className="text-lg font-bold text-gray-800">{forum.name}</p>
                  <p className="text-gray-700">
                    <span className="font-medium">Instructor:</span> {forum.teacher_name}
                ...
                <form onSubmit={handlePurchase} className="space-y-4">
                  <div>
                    <label htmlFor="bank" className="block text-gray-700 font-medium">Select Bank</label>
                    <select
                      id="bank"
                      value={bank}
                    ...
                    >
                      <option value="" disabled>Choose a Virtual Account Bank</option>
